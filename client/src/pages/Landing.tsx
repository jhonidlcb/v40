...
export default function Landing() {
  ...
  return (
    <Layout onAuthClick={openAuthModal}>
      ...
      <section id="inicio" className="pt-28 pb-20 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 h-full flex flex-col justify-center">
                  ...
                  >
                    ...
                    {heroSlides[currentSlide]?.description && (
                      <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed font-normal drop-shadow-lg">
                        {heroSlides[currentSlide].description}
                      </p>
                    )}
